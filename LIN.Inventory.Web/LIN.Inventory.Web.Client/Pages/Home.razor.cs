...
public partial class Home : IDisposable, INotificationModelObserver
{
    ...
    private static async Task<bool> RefreshData()
    {
        ...
        // Items
        var items = await Access.Inventory.Controllers.InventoryAccess.ReadNotifications(Access.Inventory.Session.Instance.Token);
    ...
    private async Task<bool> RefreshDataHome()
    {
        ...
        try
        {
            ...
            // Items
            var items = await Access.Inventory.Controllers.Statistics.HomeStatistics(Access.Inventory.Session.Instance.Token);
